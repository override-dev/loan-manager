...
// @ts-ignore
import { LoanRequestBuilderNavigationMetadata, LoanRequestBuilderRequestsMetadata, type LoanRequestBuilder } from './loan/index.js';
// @ts-ignore
...
export const MyTsClientNavigationMetadata: Record<Exclude<keyof MyTsClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    loan: {
        ...
        navigationMetadata: LoanRequestBuilderNavigationMetadata,
    },
    weatherforecast: {
